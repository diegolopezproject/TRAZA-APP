  ...
  return (
    <section className="trip-view" aria-labelledby="trip-title">
      ...
      <section className="travel-doc travel-doc--flight" aria-labelledby="flights-title">
        <div className="doc-kicker"><span>01 · {es.trip.flights}</span><PlaneIcon /></div>
        <h2 id="flights-title">Ida y vuelta</h2>
      ...
      <section className="travel-doc travel-doc--stay" aria-labelledby="stay-title">
        <div className="doc-kicker"><span>02 · {es.trip.stay}</span><MapIcon /></div>
        <h2 id="stay-title">{trip.hotel.name}</h2>
      ...
      <section className="travel-doc travel-doc--transfers" aria-labelledby="transfers-title">
        <div className="doc-kicker"><span>03 · {es.trip.transfers}</span><ArrowIcon /></div>
        <h2 id="transfers-title">Llegar y volver.</h2>
      ...
      <section className="travel-doc travel-doc--bookings" aria-labelledby="bookings-title">
        <div className="doc-kicker"><span>04 · {es.trip.bookings}</span><TicketIcon /></div>
        <div className="bookings-total"><strong>{anchors.length}</strong><span>puntos fijos<br />del viaje</span></div>
        <h2 id="bookings-title">Reservas confirmadas</h2>
