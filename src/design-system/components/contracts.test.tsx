...
describe("Core interactive contracts", () => {
  it("marks exactly one navbar destination as current", () => {
    ...
    expect(markup.match(/aria-current="page"/g)).toHaveLength(1); expect(markup).toContain("Guardados"); expect(markup.match(/ds-bottom-navigation__active-pill/g)).toHaveLength(1);
  });
